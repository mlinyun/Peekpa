...
declare global {
  ...
  const IconEpChromeFilled: typeof import('~icons/ep/chrome-filled')['default']
  ...
  const IconEpFolderChecked: typeof import('~icons/ep/folder-checked')['default']
  const IconEpFolderDelete: typeof import('~icons/ep/folder-delete')['default']
  const IconEpFolderOpened: typeof import('~icons/ep/folder-opened')['default']
  const IconEpGoldMedal: typeof import('~icons/ep/gold-medal')['default']
  const IconEpHouse: typeof import('~icons/ep/house')['default']
  const IconEpMedal: typeof import('~icons/ep/medal')['default']
  const IconEpNotebook: typeof import('~icons/ep/notebook')['default']
  const IconEpOdometer: typeof import('~icons/ep/odometer')['default']
  const IconEpSetting: typeof import('~icons/ep/setting')['default']
  const IconEpStopwatch: typeof import('~icons/ep/stopwatch')['default']
